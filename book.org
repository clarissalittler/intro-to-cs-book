...
** A bug finding program
   The goal of this project is to learn a little bit of how static analysis works. Not very deep, but little things like analyzing whether every branch in a function has a return statement or things like that. Checking to make sure every variable used was defined first. Things like that. 
