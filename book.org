...
** Switch Statements
:META:
   Part of my problem here is that switch statements in javascript are a pretty weird topic: they don't seem to be particularly idiomatic even though they're useful for "tagged" data, but that's mostly because I think like a functional programmer and like algebraic data types
:END:
** Error Handling
   (describe try and catch)
** Modules
...
*** Polymorphism in Number of Arguments
* Advanced Topics
** Correctness
*** Specification
*** Testing Code
