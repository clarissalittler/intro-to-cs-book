...
** Basic Types
   (These sections should all be fairly short and to the point. The idea is to simultaneously  be rigorous but get intuition into students right away. There should be a general discussion of why there's different forms of data and how we consider "types of things" all the time informally. Basically, we need to describe how data-are-nouns in this section and really solidify the analogy that you need to learn both the nouns and the verbs of any language)
*** Strings
...
** Abstract Data Types
   (I'm strongly considering moving these to be piecemeal introduced through the text every so often as small projects and to break up the monotony)
*** Linked Lists
**** Doubly Linked Lists
*** Stacks
*** Queues
