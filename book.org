...
** The Goals of This Book
   ...
   On the other hand, we have to pick a particular language in order to write this book and to that end I've chosen the Javascript programming language. Why JavaScript? Because at the end of the day JavaScript is a very flexible, popular, language 
...
*** 								       :meta:
    We need to flesh this section out with information about keywords. The idea here is that we have simple keywords in our informal descriptions that help us flesh out the structure of our programs. 
** A First Problem
...
*** 								       :meta:
    Include some text about how this section can be skimmed the first time for reference and then the students can go onto the parts that actually evaluate code
*** Strings
...
**** Real life examples and analogues
     We see numbers all the time in our lives
**** Syntax
     Syntax of numbers is exactly as we usually use them, also two special numbers Infinity and NaN
**** Evaluation
     Numbers evaluate to themselves
**** Operations
     +, - , /, %
**** Exercises
     Include simple exercises on
     1. precedence of operations
     2. Infinity and Nan

     Conceptual questions on the use of NaN and Infinity and why they should or shouldn't be in the language
*** Booleans
**** Real life examples and analogues
...
*** Undefined
    Undefined comes up naturally when we're discussing variables
*** Exercises
...
*** If-statements
**** Real life examples and analogues
     If statements are represented by our notion of decisions in our directions. Keywords are /if/ or /when/. Whenever your informal description includes /if/ or /when/, you're going to have some kind of if-statement
**** Syntax
     Explain the standard if-else form first, then explain that it can be either just if or if else-if form as well in order to properly chain 
**** Evaluation
...
*** Closures can mimick modules
    Need to explain the idea of "modules" and namespaces here. Maybe explain the idea of hiding code and having qualified names.
** Objects
*** 								       :meta:
    This probably needs to be moved earlier
